...
from Location.coordinates import get_location
...
cap = cv2.VideoCapture('http://192.168.203.60:2020/video')
    ...
    for i in indices:
        ...
        if classNames[classIds[i]] == 'fire':
            ...
            if(flag == True):
                raise_alarm()
                emailme.email_alert(
                    'http://192.168.203.60:2020/video')
                flag = False
